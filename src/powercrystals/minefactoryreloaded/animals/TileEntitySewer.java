...
public class TileEntitySewer extends TileEntityFactoryInventory implements ITankContainer
{
	...
	public void updateEntity()
	{
		...
		if(_nextSewerCheckTick <= worldObj.getTotalWorldTime())
		{
			...
			{
				if(worldObj.getBlockId(bp.x, bp.y, bp.z) == MineFactoryReloadedCore.machineBlock0.blockID &&
						worldObj.getBlockMetadata(bp.x, bp.y, bp.z) == MineFactoryReloadedCore.machine0MetadataMappings.get(Machine.Sewer) &&
